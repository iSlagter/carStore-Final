...
namespace carStore_Final
{
    class FourWheels : Vehicle
    {
        ...
        public FourWheels(int DoorNumber, bool IsAC, bool IsMultimedia, string Make, string Model, string Year, string Color, double Price, string Description) : base(Make, Model, Year, Color, Price, Description)
        {
